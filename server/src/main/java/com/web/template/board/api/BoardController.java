...
public class BoardController {
    ...
    public Map publicCreate(@RequestBody BoardAddCommand boardAddCommand) {
    ...
    @PostMapping("/board")
    public Map create(@RequestBody BoardAddCommand boardAddCommand) {
    ...
    public Map update(@PathVariable Long boardId, @RequestBody BoardAddCommand boardAddCommand) {
    ...
    @GetMapping("/boards")
    public PagePresentation<Map> getList(PageCommand pageCommand) {
        return boardService.getList(pageCommand);
    }
    ...
    @GetMapping("/board/{id}")
    public Map getBoard(@PathVariable Long id) {
